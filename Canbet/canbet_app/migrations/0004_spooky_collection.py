...
SPOOKY_ITEMS = [
    ...
    ('Mummy',                       'RARE',        40, 'sprites/Items/SpookyCollection/mummy.png'),
    ('Vampire',                     'RARE',        40, 'sprites/Items/SpookyCollection/Vampire.png'),
    ('Gargoyle',                    'RARE',        40, 'sprites/Items/SpookyCollection/Gargoyle.png'),
    ('Creature from the Black Lagoon', 'EPIC',     15, 'sprites/Items/SpookyCollection/creature from the black lagoon.png'),
    ('Evil Robot',                  'EPIC',        15, 'sprites/Items/SpookyCollection/evil robot.png'),
